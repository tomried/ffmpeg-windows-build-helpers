...
build_ffmpeg() {
  ...
  cd $output_dir
    ...
    config_options+=" --enable-decoder=aac,h264,mjpeg,mpeg2video,mpeg4"
    config_options+=" --enable-encoder=aac,mpeg4,libx264"
    config_options+=" --enable-protocol=concat,file"
    config_options+=" --enable-demuxer=aac,avi,h264,image2,matroska,pcm_s16le,mov,m4v,rawvideo,wav"
    config_options+=" --enable-muxer=h264,ipod,mov,mp4"
    config_options+=" --enable-parser=aac,h264,mjpeg,mpeg4video,mpegaudio,mpegvideo,png"
    config_options+=" --enable-bsf=aac_adtstoasc"
    config_options+=" --enable-filter=transpose"
